...
<body>
	<div class="top">>>帐号维护</div>
	<div class="cx">
		创建日期：从 <input id="start" class="Wdate"
		...
		<p>
			按项目村查询：<input id="cun" />			<button  onclick="sel(2)">按村庄查询</button>
		<p>
			<span><a href="${ctx }/html/adduser.jsp" target="fbottom">添加用户</a></span>
	</div>
